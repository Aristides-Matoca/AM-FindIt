...
export default function Achados(nav){
    return(
        <View style={styles.conteiner}>
            ...
            <ScrollView>
                ...
                <View style={styles.lost3}>
                    <Text style={styles.txt}>Telefone Samsung Flip</Text>

                    <TouchableOpacity style={{width: '95%', left: 12, top: 10}} onPress={() => nav.navigation.navigate('Artigos')}>
                        <Image style={styles.img1} source={require('../../imagens/Samsung.png')}></Image>
                    </TouchableOpacity>
                </View>

                <View style={styles.lost4}>
                    <Text style={styles.txt}>Pulseira Preta</Text>
