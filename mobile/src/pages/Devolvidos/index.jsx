...
export default function Devolvidos(nav){
    return(
        <View style={styles.conteiner}>
            ...
            <ScrollView>
                <View style={styles.lost1}>
                    <Text style={styles.txt}>Pulseira</Text>

                    <TouchableOpacity style={{width: '95%', left: 12, top: 10}} onPress={() => nav.navigation.navigate('Artigos')}>
                        <Image style={styles.img1} source={require('../../imagens/Pulseira.png')}></Image>
                    </TouchableOpacity>
                </View>
                ...
                <View style={styles.lost4}>
                    <Text style={styles.txt}>Calculadora Científica</Text>

                    <TouchableOpacity style={{width: '95%', left: 12, top: 10}} onPress={() => nav.navigation.navigate('Artigos')}>
                        <Image style={styles.img1} source={require('../../imagens/calculadora.png')}></Image>
                    </TouchableOpacity>
                </View>
            </ScrollView>
